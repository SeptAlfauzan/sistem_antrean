...
public class AntreanProcedural extends javax.swing.JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        btnTambahNomorAntrian.setFont(new Font("Calibri", Font.BOLD, 14));
        ...
        labelNomorPanggilan.setFont(new Font("Calibri", Font.BOLD, 14));
        labelTotalAntrian.setFont(new Font("Calibri", Font.BOLD, 14));
